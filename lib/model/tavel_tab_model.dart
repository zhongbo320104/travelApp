...
class TravelParams {
  ...
  TravelParams.fromJson(Map<String, dynamic> json) {
    ...
    pagePara = json['pagePara'] != null
        ? new TravelPagePara.fromJson(json['pagePara'])
        : null;
...
class TravelPagePara {
  int pageIndex;
  int pageSize;
  int sortType;
  int sortDirection;

  TravelPagePara({this.pageIndex, this.pageSize, this.sortType, this.sortDirection});

  TravelPagePara.fromJson(Map<String, dynamic> json) {
